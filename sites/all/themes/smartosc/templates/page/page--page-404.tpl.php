          ...
          <div class="col-md-12">
            <div class="page-not-found">
              <div class="page-inner">
                ...
                <h2 class="title"><?php print $title_notfound; ?></h2>
                <div class="content"><?php print $content_notfound; ?></div>
                <p class="back-to"><?php print t('Back to'); ?><a href="<?php print $front_page; ?>"> <?php print t('home'); ?> </a> <?php print t('or'); ?> <a href="<?php print $front_page.'/contact' ?>"><?php print t('contact us'); ?></a></p>
