...
?>
<div class="embed-responsive embed-responsive-16by9 <?php print $classes; ?> media-youtube-<?php print $id; ?>">
  <iframe class="embed-responsive-item media-youtube-player" <?php print $api_id_attribute; ?>width="<?php print $width; ?>" height="<?php print $height; ?>" title="<?php print $title; ?>" src="<?php print $url; ?>" allowfullscreen><?php print $alternative_content; ?></iframe>
</div>
