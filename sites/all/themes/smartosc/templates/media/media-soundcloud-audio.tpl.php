 ...
 *
 */
$link_url=str_replace("&","&amp;",$url);
?>
<div class="embed-responsive embed-responsive-16by9 <?php print $classes; ?> media-soundcloud-<?php print $id; ?>">
  <iframe class="embed-responsive-item media-soundcloud-player" <?php print $api_id_attribute; ?>width="<?php print $width; ?>" height="<?php print $height; ?>" src="<?php print $link_url; ?>" allowfullscreen><?php print $alternative_content; ?></iframe>
</div>
